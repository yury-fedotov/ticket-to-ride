...
default_routes = (
    ...
    Route(cities=(default_cities["Los Angeles"], default_cities["Las Vegas"]), length=2, color=Color.BLACK),
    ...
    Route(cities=(default_cities["Salt Lake City"], default_cities["Portland"]), length=6, color=Color.BLUE),
    Route(cities=(default_cities["Salt Lake City"], default_cities["San Francisco"]), length=5, color=Color.ORANGE),
    Route(cities=(default_cities["Salt Lake City"], default_cities["San Francisco"]), length=5, color=Color.WHITE),
    ...
    Route(cities=(default_cities["El Paso"], default_cities["Los Angeles"]), length=6, color=Color.BLACK),
    ...
    Route(cities=(default_cities["New Orleans"], default_cities["Miami"]), length=6, color=Color.RED),
    ...
    Route(cities=(default_cities["Atlanta"], default_cities["Miami"]), length=5, color=Color.BLUE),
    ...
    Route(cities=(default_cities["Sault Ste Marie"], default_cities["Winnipeg"]), length=6, color=Color.NEUTRAL),
    ...
    Route(cities=(default_cities["Duluth"], default_cities["Winnipeg"]), length=4, color=Color.BLACK),
